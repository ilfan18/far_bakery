...
ROOT_URLCONF = "far_bakery.urls"

TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            "far_bakery/templates",
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
WSGI_APPLICATION = "far_bakery.wsgi.application"
...
if "DATABASE_URL" in os.environ:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.path.join(BASE_DIR, "far_bakerydb"),
        }
    }
