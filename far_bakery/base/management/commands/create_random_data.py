...
from far_bakery.base.models import FooterText, HomePage, Person, StandardPage
from far_bakery.blog.models import BlogIndexPage, BlogPage
from far_bakery.breads.models import (
    BreadIngredient,
    BreadPage,
    BreadsIndexPage,
    BreadType,
...
from far_bakery.locations.models import LocationPage, LocationsIndexPage
